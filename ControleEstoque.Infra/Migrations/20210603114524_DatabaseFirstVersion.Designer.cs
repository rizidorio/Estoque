...
namespace ControleEstoque.Infra.Migrations
{
    ...
    [Migration("20210603114524_DatabaseFirstVersion")]
    partial class DatabaseFirstVersion
    {
            ...
            modelBuilder.Entity("ControleEstoque.Domain.Entity.Product", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeDate")
                        ...
                        .HasDefaultValue(new DateTime(2021, 6, 3, 8, 45, 4, 765, DateTimeKind.Local).AddTicks(4540));
            ...
            modelBuilder.Entity("ControleEstoque.Domain.Entity.StockMovement", b =>
                {
                    ...
                    b.Property<DateTime>("DateMovement")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2021, 6, 3, 8, 45, 4, 767, DateTimeKind.Local).AddTicks(5985));
